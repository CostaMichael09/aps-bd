...
import apsbanco.service.MedicoService;
...
/**
 * REST controller for managing {@link apsbanco.domain.Medico}.
 */
@RestController
@RequestMapping("/api")
public class MedicoResource {
    ...
    public ResponseEntity<MedicoDTO> updateMedico(
        ...
        MedicoDTO result = medicoService.update(medicoDTO);
        return ResponseEntity
            .ok()
     ...
     */
    @GetMapping("/medicos")
    public ResponseEntity<List<MedicoDTO>> getAllMedicos(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
