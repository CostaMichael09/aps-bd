package apsbanco.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        apsbanco.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        apsbanco.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(apsbanco.service.InvalidPasswordException ex, NativeWebRequest request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "apsbanco");
    }
}
